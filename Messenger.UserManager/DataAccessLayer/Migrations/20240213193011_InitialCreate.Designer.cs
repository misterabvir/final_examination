...
namespace Messenger.UserManager.DataAccessLayer.Migrations
{
    ...
    [Migration("20240213193011_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.UserManager.Domain.RoleType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Messenger.UserManager.Domain.User", b =>
                {
                    b.HasOne("Messenger.UserManager.Domain.RoleType", "RoleType")
                        .WithMany()
